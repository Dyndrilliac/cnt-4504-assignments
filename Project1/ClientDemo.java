	...
	public static void main(String[] args)
	{
		...
		EventHandler myDrawGUI = new EventHandler()
		{
			public final void run(final Object... arguments) throws IllegalArgumentException
			{
				...
				RichTextPane		outputBox	= new RichTextPane((Component)window, true, window.isDebugging(), ClientDemo.textFont);
		...
		myWindow = new ApplicationWindow(null, "Client Demo", new Dimension(600, 400), debugMode, false, 
			myActionPerformed, myDrawGUI);
		myThread = new CNT4504Project1Code.CNT4504Project1ClientThread(myWindow, "localhost", 15000);
		myThread.start();
